...
for circuit, threshold in [("Sakhir", 0.5), ("Monaco", 0.3), ("Silverstone", 0.3)]:
    report = generate_tire_report(
        model, circuit=circuit, track_temp_c=30.0, degradation_threshold_s=threshold, training_df=df,
    )
